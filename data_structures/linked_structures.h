...
template <typename T> class LinkedStack {
  public:
    //! construtor simples
    LinkedStack() { list = new DoublyLinkedList<T>(); }
    //! destrutor
    ~LinkedStack() { list->clear(); }
    //! metodo empilha
    void push(const T &data) { list->push_back(data); }
    //! metodo desempilha
    T pop() { return list->pop_back(); }
    //! metodo retorna o topo
    T &top() { return list->at(list->size() - 1); }
    //! metodo limpa pilha
...
template <typename T> class LinkedQueue {
  public:
    LinkedQueue() { list = new DoublyLinkedList<T>(); }
    ...
    void enqueue(const T &data) { list->push_back(data); }

    T dequeue() { return list->pop_front(); }

    T &front() const { return list->at(0); }

    T &back() const { return list->at(list->size() - 1); }
